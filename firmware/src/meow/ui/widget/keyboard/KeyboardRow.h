...
namespace meow
{
    ...
    public:
         ...
         */
        inline void setBtnHeight(uint16_t height)
        {
         ...
         */
        inline uint16_t getBtnsHeight() const { return _btn_height; }
         ...
         */
        inline void setBtnWidth(uint16_t width)
        {
         ...
         */
        inline uint16_t getBtnsWidth() const { return _btn_width; }

        /*!
         * @return
         *        Позицію кнопки для данного ряду, на якій встановлено фокус.
         */
        inline uint16_t getCurFocusPos() const { return _cur_focus_pos; }
