...
#include "meow/util/wifi/WiFiScanner.h"
#include "meow/util/wifi/WiFiConnect.h"
...
{
    class TestServerScreen : public IContext
    {
    public:
        TestServerScreen(GraphicsDriver &display);
        virtual ~TestServerScreen();
