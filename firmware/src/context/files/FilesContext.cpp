...
void FilesContext::loop()
{
}

FilesContext::FilesContext(GraphicsDriver &display) : IContext(display)
{
...
void FilesContext::showContextMenu()
{
    ...
    _context_menu = new FixedMenu(ID_CNTXT_MENU, _display);
...
{
    getLayout()->deleteWidgetByID(ID_CNTXT_MENU);
    _mode = MODE_NAVIGATION;
    _files_list->enable();
}
